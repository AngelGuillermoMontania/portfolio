    ...
    <>
      ...
      >
        <div className="h-24 w-24">
          <svg
            className="w-24 h-24 svgAnimeInfinit svgHeader hidden"
            viewBox="0 0 723 577"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              className="stroke-[21px]"
              d="M711.997 351.568C712.704 364.565 574.791 398.762 471.536 395.322C388.932 392.569 350.326 395.322 315.326 395.322C305.073 387.832 -79.9314 425.673 31.08 444.2C51.0097 447.526 320.897 515.777 406.825 557.062C475.567 590.09 490.395 523.677 489.216 486.342C481.829 320.007 401.302 2.36452 471.536 11.1797C541.77 19.9949 225.954 477.23 169.551 542.918C113.148 608.605 320.503 410.679 410.074 355.51C470.278 318.429 610.468 303.291 576.238 385.862C533.451 489.075 268.563 586.497 164.247 500.486C80.7945 431.677 263.965 68.9026 598.483 43.2905C621.943 41.8558 660.663 43.9531 627.855 63.8196"
              stroke="#2707EA"
            />
          </svg>
        </div>
        ...
        <a
          href="#about"
          className="my-4 font-bold relative z-50 hover:scale-125 duration-500 transition-all"
        >
          ABOUT
        </a>
        <a
        ...
        >
          <svg
            ...
            className="w-5 h-5 hidden fill-black dark:block"
            fill="currentColor"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <svg
            ...
            className="w-5 h-5 fill-white dark:hidden"
            fill="currentColor"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      <svg
        className="absolute hidden z-40 -top-3 left-2 w-[35rem] h-[35rem] svgG svgAnimeInfinit"
        viewBox="0 0 723 577"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
