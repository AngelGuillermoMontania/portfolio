    ...
    <div id="contact" className="h-[3800px] w-full text-white dark:text-black">
      <div className="sticky h-screen top-0 flex flex-col items-center justify-around">
        ...
        <div className="flex w-3/4 mx-auto mt-8 justify-around animeIconsContact">
          ...
          <a
            href={`mailto:angelguillermomontania@gmail.com`}
            target="_blank"
            rel="noreferrer noopener"
          >
            <svg
              className="w-22 h-16 hover:scale-150 hover:rotate-[360deg] duration-1000 transition-all"
              viewBox="0 0 580 408"
              fill="none"
            ...
            >
              ...
              <path
                d="M15 67C15 49.8792 28.8792 36 46 36H59C76.1208 36 90 49.8792 90 67V377C90 394.121 76.1208 408 59 408H46C28.8792 408 15 394.121 15 377V67Z"
                fill="#FF1B00"
              />
              <path
                d="M15 36H90H15ZM90 408H15H90ZM15 408V36V408ZM59 36C86.6142 36 109 58.3858 109 86V358C109 385.614 86.6142 408 59 408C65.6274 408 71 394.121 71 377V67C71 49.8792 65.6274 36 59 36Z"
                fill="#FF1B00"
              ...
              <path
                d="M489 67C489 49.8792 502.879 36 520 36H534C551.121 36 565 49.8792 565 67V377C565 394.121 551.121 408 534 408H520C502.879 408 489 394.121 489 377V67Z"
                fill="#FF1C00"
              />
              <path
                d="M489 36H565H489ZM565 408H489H565ZM489 408V36V408ZM534 36C561.614 36 584 58.3858 584 86V358C584 385.614 561.614 408 534 408C540.627 408 546 394.121 546 377V67C546 49.8792 540.627 36 534 36Z"
                fill="#FF1B00"
              ...
              <path
                d="M71 88V408H109V88H71Z"
                fill="#FF1B00"
                mask="url(#path-6-inside-3_0_1)"
              />
              ...
              <path
                d="M502 88V408H540V88H502Z"
                fill="#FF1C00"
                mask="url(#path-8-inside-4_0_1)"
              />
              ...
              <path
                d="M264.324 239.372C250.283 219.319 255.156 191.682 275.208 177.641L496.006 23.0367C516.058 8.99604 543.696 13.8693 557.737 33.9215V33.9215C571.777 53.9736 566.904 81.6112 546.852 95.6519L326.054 250.256C306.002 264.297 278.364 259.424 264.324 239.372V239.372Z"
                fill="#DF3621"
              />
              <path
                d="M238.901 203.064L532.314 -2.38614L238.901 203.064ZM557.737 33.9215C579.063 64.3789 571.661 106.358 541.204 127.685L358.087 255.905C327.629 277.231 285.65 269.829 264.324 239.372L264.324 239.372C271.078 249.018 292.81 245.456 312.862 231.416L533.66 76.8114C553.712 62.7708 564.491 43.5683 557.737 33.9215L557.737 33.9215ZM289.746 275.679L238.901 203.064L289.746 275.679ZM532.314 -2.38614L583.16 70.229L532.314 -2.38614Z"
                fill="#DF3621"
                mask="url(#path-10-inside-5_0_1)"
              />
              ...
              <path
                d="M22.0724 33.7625C36.113 13.7104 63.7507 8.83709 83.8028 22.8777L304.819 177.635C324.871 191.676 329.745 219.313 315.704 239.365V239.365C301.663 259.418 274.026 264.291 253.973 250.25L32.9571 95.4929C12.905 81.4523 8.03174 53.8146 22.0724 33.7625V33.7625Z"
                fill="#DF3621"
              />
              <path
                d="M47.4952 -2.5451L341.127 203.058L47.4952 -2.5451ZM315.704 239.365C294.377 269.823 252.398 277.225 221.941 255.898L38.6054 127.526C8.14792 106.199 0.745848 64.2199 22.0724 33.7625L22.0724 33.7625C15.3176 43.4093 26.0973 62.6118 46.1494 76.6524L267.166 231.41C287.218 245.45 308.949 249.012 315.704 239.365L315.704 239.365ZM-3.35046 70.0701L47.4952 -2.5451L-3.35046 70.0701ZM341.127 203.058L290.281 275.673L341.127 203.058Z"
                fill="#DF3621"
                mask="url(#path-12-inside-6_0_1)"
              />
              ...
              <path
                d="M320.874 253.883L270.028 181.268L207.773 224.86L258.619 297.475L320.874 253.883Z"
                fill="#DF3621"
                mask="url(#path-14-inside-7_0_1)"
              />
              <mask id="path-16-inside-8_0_1" fill="white">
                <path d="M50.8457 0L340.591 202.882L289.745 275.497L8.40896e-08 72.6152L50.8457 0Z" />
              </mask>
              <path
                d="M309.463 181.086L258.618 253.701L320.873 297.293L371.719 224.678L309.463 181.086Z"
                fill="#DF3621"
                mask="url(#path-16-inside-8_0_1)"
              />
            </svg>
          </a>
          <a href="www.google.com" target="_blank" rel="noreferrer noopener">
        ...
        <div className="h-3/4 w-full flex justify-center items-center relative">
          <form
            className="bg-blackSecundary w-3/4 h-3/4 flex flex-col justify-around items-center p-4 animeForm border-double border-4 shadow-2xl shadow-black dark:shadow-black rounded-2xl border-greenPrimary dark:bg-slate-200"
          ...
          >
            ...
            <div className="flex w-full justify-around">
              <div className="w-1/3 flex justify-center items-center relative">
                ...
                />
                {errors.title && (
                  <p className="text-red-700 absolute top-full">
                    {errors.title}
                  </p>
                )}
              </div>
            ...
            <div className="w-2/3 flex flex-col justify-center items-center relative">
              ...
              />
              {errors.body && (
                <p className="text-red-700 absolute top-1/2">{errors.body}</p>
              )}
            </div>
            <button
              type="submit"
              className="border-2 border-double border-black py-1 mx-4 px-2 rounded-lg bg-greenPrimary hover:bg-blue-700 hover:border-white hover:scale-125 duration-700 text-black hover:text-white transition-all"
            >
              Send Message
            </button>
          </form>
          <p className="text-green-600 absolute bottom-4 text-4xl">
            {successMessage}
          </p>
        </div>
      </div>
