...
import photo from "../../../assets/images/photo/index";
const grid = [10, 10];
...
const Photo = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="rounded-full flex flex-col opacity-0 flex-wrap staggering-grid-demo h-[25rem] w-[25rem]">
      ...
      <div className="flex w-full mt-8 justify-around items-center opacity-0 animeIconsInit">
        <a href="www.sdajk.com" target="_blank" rel="noreferrer noopener">
          <svg
            viewBox="0 0 128 128"
            className="w-8 h-8 hover:scale-150 hover:rotate-[360deg] duration-1000 transition-all"
          >
            <path
        ...
        >
          <svg
            className="w-10 h-8 hover:scale-150 hover:rotate-[360deg] duration-1000 transition-all"
            viewBox="0 0 580 408"
            fill="none"
        ...
        <a href="www.sahda.com" target="_blank" rel="noreferrer noopener">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
